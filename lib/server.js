...
var driver = require('adafruit-i2c-pwm-driver')
var pwm = driver({ address: 0x40, device: '/dev/i2c-0', debug: true });
...
module.exports = function(droid) {
	...
	app.post('/test', function(req, res){
		...
		pwm.setPWM(15, parseInt(req.body.start), parseInt(req.body.end));
	...
	app.post('/test2', function(req, res){
		...
		pwm.setPWM(parseInt(req.body.port), 1550, 1550 + parseInt(req.body.angle));
